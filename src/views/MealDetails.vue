        ...
        <div class="absolute bottom-0 left-0 right-0 p-6">
          <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              <span v-if="meal.strArea" class="bg-blue-500 text-white px-3 py-1 rounded-full text-sm font-semibold">
                {{ meal.strArea }}
              </span>
              <span v-if="meal.strTags" class="bg-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold">
                {{ meal.strTags }}
              </span>
            </div>
          </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
              <h2 class="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                <svg class="w-6 h-6 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v6a2 2 0 002 2h2m0-8v8m0-8h8a2 2 0 012 2v6a2 2 0 01-2 2h-8"></path>
                </svg>
                Ingredients
              </h2>
              <ul class="space-y-3">
...
const fetchMealDetails = async () => {
  ...
  try {
    ...
    error.value = 'Failed to load meal details. Please check your internet connection and try again.'
